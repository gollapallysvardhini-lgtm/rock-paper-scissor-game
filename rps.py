...
def reset_timer(window, timer_label):
    ...
    start_timer(window, 10, timer_label)  
...
def show_loading():
    ...
    set_background(loading, "background.png")  
...
def show_main_menu():
    ...
    set_background(main_menu, "background.png")  
...
def choose_game_mode(prev_window):
    ...
    set_background(mode_window, "background.png")  
...
def get_player_names(prev_window, selected_mode):
    ...
    set_background(name_window, "background.png")  
...
def start_game(prev_window, selected_mode, p1, p2, rounds):
    ...
    set_background(game_window, "background.png")  
    ...
    start_timer(game_window, 10, timer_label)  
    ...
    images = {
        "rock": PhotoImage(file="rock.png").subsample(4, 4),  
        "paper": PhotoImage(file="paper.png").subsample(4, 4),  
        "scissors": PhotoImage(file="scissors.png").subsample(4, 4)  
    }
...
def show_final_result():
    ...
    set_background(result_window, "background.png")  
    if score1 > score2:
